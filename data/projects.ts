...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    slug: 'cyberbug',
    index: '04',
    title: 'CyberBug — AI Cybersecurity Platform',
    year: '2026',
    description: 'An AI-driven cybersecurity detection platform for unidirectional IP traffic that observes, analyzes, detects, explains, and alerts — without ever interfering with the protected network.',
    tags: ['Python', 'TypeScript', 'AI'],
    repoUrl: 'https://github.com/NandaKumar876/cyberbug',
    features: [
      { title: 'Hybrid AI Detection', description: 'Combines rule engines, machine learning models, and anomaly detection for comprehensive threat identification.' },
      { title: 'Threat Behaviour Fingerprint', description: 'Generates unique DNA-style fingerprints for detected threats, enabling pattern recognition across incidents.' },
      { title: 'Explainable Evidence', description: 'Provides transparent, human-readable reasoning for every detection with risk and confidence scoring.' },
      { title: 'SOC Dashboard', description: 'Real-time security operations center dashboard with alert correlation, attack timelines, and incident management.' },
    ],
  },
  {
    id: 'nanda-portfolio',
